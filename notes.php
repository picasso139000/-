  ...
  <div class="row justify-content-center" data-aos="zoom-in" data-aos-delay="100">
    ...
    <div class="col-xl-4 col-lg-6" data-aos="fade-up" data-aos-delay="400">
          ...
          <div class="col-xl-4 col-lg-6" data-aos="fade-up" data-aos-delay="500">
            <div class="service-item d-flex" style="background-color: #EFF0EF; margin:2px 2px; height: 300px; padding:10px;">
              <div class="icon flex-shrink-0" style="margin-left: 10px !important"><i class="bi bi-brightness-high"></i></div>
              <div>
                <h4 class="title"><a href="service-details.html" class="stretched-link">Nemo Enim</a></h4>
                <p class="description">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praese
                </p>
              </div>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-xl-4 col-lg-6" data-aos="fade-up" data-aos-delay="600">
            <div class="service-item d-flex" style="background-color: #EFF0EF; margin:2px 2px; height: 300px; padding:10px;">
              <div class="icon flex-shrink-0" style="margin-left: 10px !important"><i class="bi bi-calendar4-week"></i></div>
              <div>
